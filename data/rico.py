...
class RICO20_sub(datasets.ImageFolder):
    def __init__(self, subset_file, root=MyPath.db_root_dir('rico-20'), split='train', 
                    transform=None):
        super(RICO20_sub, self).__init__()

        # getting training images path (based on path not actual folder seperation)
